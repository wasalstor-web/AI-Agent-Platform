...
"""
        ...
        print(f"✅ ملف التكوين تم إنشاؤه / Config file created")
        ...
        print(f"✅ الخدمة تم إعادة تشغيلها / Service restarted")
        ...
        result = await executor.execute(
            "log_view",
            {"log_type": "execution", "lines": 5}
        )
        print(f"✅ العمليات الأخيرة / Recent operations:")
